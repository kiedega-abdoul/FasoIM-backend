...
class Seance(models.Model):
    ...
    def clean(self):
        ...
        if self.date_fin_reelle and not self.date_debut_reelle:
            erreurs["date_fin_reelle"] = (
                "La séance doit être démarrée avant d'être terminée."
            )

        if (
            self.date_debut_reelle
            and self.date_fin_reelle
            and self.date_fin_reelle < self.date_debut_reelle
        ):
            erreurs["date_fin_reelle"] = (
