...
PERMISSIONS_SYSTEME = [
    ...
    PermissionDefinition("demarrer_seance", "Démarrer une séance", "activites", "Confirmer le démarrage réel d'une séance planifiée."),
    PermissionDefinition("terminer_seance", "Terminer une séance", "activites", "Confirmer la fin réelle d'une séance après clôture des traitements requis."),
...
PERMISSIONS_METIER_PAR_ROLE = {
    "ADMINISTRATEUR": {
        ...
        "affecter_formateur_seance", "demarrer_seance",
        "terminer_seance", "consulter_evaluations",
    ...
    "FORMATEUR": {
        "consulter_session", "lister_sessions", "consulter_centre",
        "consulter_activites", "consulter_seances", "demarrer_seance",
        "terminer_seance", "consulter_presences",
